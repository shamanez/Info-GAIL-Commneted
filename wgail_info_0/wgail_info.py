...
def playGame(finetune=0):
    ...
    demo_dir = "/home/dl/Desktop/human_0/"
    param_dir = "/home/dl/Desktop/wgail_info_params_0/"
    pre_actions_path = "/home/dl/Desktop/human_0/pre_actions.npz"
    feat_dim = [7, 13, 1024]
    img_dim = [50, 50, 3]
    aux_dim = 10
    encode_dim = 2
    ...
    # define the model
    pre_actions = np.load(pre_actions_path)["actions"] #200 actions
